...
preferences {
    page(name: "mainPage", title: "Install Video Camera", install: true, uninstall:true) {
        ...
        section("Add a Camera") {
            ...
            ["rtsp://vampvegan644@gmail.com:0000@[192.168.7.94]/Streaming/Channels/1":"Name of Camera"], //Logitech Alert Camera
            ["http://[192.168.7.94]:[80]/mjpeg.cgi?vampvegan644@gmail.com=0000&=password&channel=1.mjpeg":"Name of Camera"], //Logitech Alert(tm) 700e
            ["http://vampvegan644@gmail.com:0000@[192.168.7.94s]/nphMotionJpeg?Resolution=640x480&Quality=Standard":"Name of Camera"] /Logitech Alert(tm) 700e
